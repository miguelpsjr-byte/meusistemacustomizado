// Ícones em traço (24x24), no mesmo espírito dos ícones simples do site.
const P = {
  dashboard: '<rect x="3" y="3" width="7" height="9" rx="2"/><rect x="14" y="3" width="7" height="5" rx="2"/><rect x="14" y="12" width="7" height="9" rx="2"/><rect x="3" y="16" width="7" height="5" rx="2"/>',
  kanban: '<rect x="3" y="3" width="18" height="18" rx="3"/><path d="M8 7v7M12 7v4M16 7v9"/>',
  projetos: '<path d="M4 20h16a1 1 0 0 0 1-1V8a1 1 0 0 0-1-1h-7.5L10 4H4a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1Z"/><path d="M8 11v5M12 11v3M16 11v6"/>',
  ...
  financeiro: '<path d="M19 7V4a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4h-3a2 2 0 0 0 0 4h3a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1"/><path d="M3 5v14a2 2 0 0 0 2 2h15a1 1 0 0 0 1-1v-4"/>',
  pessoal: '<path d="M3 10.5 12 3l9 7.5"/><path d="M5 9.5V20a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V9.5"/><path d="M10 21v-6h4v6"/>',
  contratos: '<path d="M14 3H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9Z"/><path d="M14 3v6h6M8 13h8M8 17h5"/>',
...
export function icon(nome, tamanho = 18) {
  return `<svg class="ico" width="${tamanho}" height="${tamanho}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${P[nome] || ''}</svg>`;
}

// Logo "Modular" do site (3 blocos + bloco pontilhado chegando)
export function logo(tamanho = 36) {
  return `<svg class="logo-icone" viewBox="-2 -2 68 68" width="${tamanho}" height="${tamanho}" aria-hidden="true"><rect x="8" y="34" width="22" height="22" rx="5" fill="currentColor"/><rect x="34" y="34" width="22" height="22" rx="5" fill="#F97316"/><rect x="8" y="8" width="22" height="22" rx="5" fill="#F59E0B"/><rect x="36" y="4" width="20" height="20" rx="5" fill="none" stroke="#F97316" stroke-width="3" stroke-dasharray="4 3" transform="rotate(12 46 14)"/></svg>`;
}
